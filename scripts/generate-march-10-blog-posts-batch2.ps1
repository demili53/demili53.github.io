...
$date = "2026-03-06"
$iso = "2026-03-06T22:10:00+09:00"

$items = @(
  [ordered]@{
    title = "관계 점검 미팅 템플릿 가이드 2026"
    slug = "romance-relationship-checkin-meeting-template-2026.html"
    summary = "감정이 터진 뒤 수습하지 않도록, 월 1회 관계 점검 미팅을 운영하는 질문 템플릿과 진행 순서를 정리했습니다."
    tags = @("연애", "소통", "관계점검")
    section = "연애"
    keywords = "연애,관계점검,커플대화,미팅템플릿,갈등예방"
    image = "love-midyear-steady.jpg"
    topic = "관계 점검 미팅"
  },
  [ordered]@{
    title = "썸에서 공식 연애 전환 타이밍 가이드 2026"
    slug = "romance-exclusive-talk-timing-guide-2026.html"
    summary = "썸 단계에서 애매함을 오래 끌지 않기 위해, 공식 연애 전환 대화를 꺼내는 시점과 문장 구조를 정리한 실전 가이드입니다."
    tags = @("연애", "썸", "관계진전")
    section = "연애"
    keywords = "연애,썸,관계전환,고백타이밍,대화법"
    image = "love-midyear-steady.jpg"
    topic = "공식 연애 전환 타이밍"
  },
  [ordered]@{
    title = "주말 사과 대화 스크립트 가이드 2026"
    slug = "romance-weekend-apology-conversation-script-2026.html"
    summary = "평일에 쌓인 감정이 주말에 폭발하지 않도록, 사과 대화의 순서와 금지 표현을 정리한 실전 스크립트 가이드입니다."
    tags = @("연애", "사과", "갈등복구")
    section = "연애"
    keywords = "연애,사과대화,갈등복구,주말대화,커플소통"
    image = "love-midyear-steady.jpg"
    topic = "주말 사과 대화"
  },
  [ordered]@{
    title = "재회 후 경계선 재설정 가이드 2026"
    slug = "romance-boundary-after-reconciliation-guide-2026.html"
    summary = "재회 직후 같은 갈등을 반복하지 않도록, 연락·만남·갈등 규칙을 다시 합의하는 경계선 재설정 방법을 정리했습니다."
    tags = @("연애", "재회", "경계선")
    section = "연애"
    keywords = "연애,재회,경계선,관계회복,규칙설정"
    image = "love-midyear-steady.jpg"
    topic = "재회 후 경계선 재설정"
  },
  [ordered]@{
    title = "장시간 통화 피로 균형 가이드 2026"
    slug = "romance-long-call-fatigue-balance-guide-2026.html"
    summary = "통화 시간이 길어질수록 지치는 커플을 위해, 통화 빈도와 길이를 조정하는 현실적인 합의 기준을 정리했습니다."
    tags = @("연애", "통화", "시간관리")
    section = "연애"
    keywords = "연애,장시간통화,피로관리,시간관리,소통"
    image = "love-midyear-steady.jpg"
    topic = "장시간 통화 피로 균형"
  },
  [ordered]@{
    title = "배달비 새는 집밥 전환 루틴 2026"
    slug = "economy-monthly-delivery-food-budget-reset-2026.html"
    summary = "배달앱 지출이 반복될 때 생활 만족도는 지키고 비용은 낮추기 위해, 주간 집밥 전환 루틴을 정리한 실전 가이드입니다."
    tags = @("경제", "식비", "지출관리")
    section = "경제"
    keywords = "경제,배달비,식비절약,집밥루틴,가계관리"
    image = "strategy-plan.jpg"
    topic = "배달비 예산 리셋"
  },
  [ordered]@{
    title = "여름 전기요금 선제 대응 가이드 2026"
    slug = "economy-electricity-bill-summer-prep-guide-2026.html"
    summary = "무더위 시즌 전기요금 급등을 막기 위해, 냉방 사용 패턴과 시간대별 절감 포인트를 정리한 실전 준비 가이드입니다."
    tags = @("경제", "전기요금", "고정비")
    section = "경제"
    keywords = "경제,전기요금,여름준비,냉방비,고정비절감"
    image = "strategy-plan.jpg"
    topic = "여름 전기요금 대응"
  },
  [ordered]@{
    title = "카드 혜택 중복 점검 가이드 2026"
    slug = "economy-credit-card-benefit-overlap-audit-2026.html"
    summary = "여러 카드를 쓰는데 체감 혜택이 낮을 때, 혜택 중복과 실적 낭비를 줄이는 카드 구조 점검법을 정리했습니다."
    tags = @("경제", "신용카드", "소비관리")
    section = "경제"
    keywords = "경제,신용카드,혜택중복,실적관리,지출최적화"
    image = "strategy-plan.jpg"
    topic = "카드 혜택 중복 점검"
  },
  [ordered]@{
    title = "월세 인상 통보 대응 체크리스트 2026"
    slug = "economy-rent-increase-response-checklist-2026.html"
    summary = "월세 인상 통보를 받았을 때 감정적으로 대응하지 않도록, 확인 서류와 협상 순서를 정리한 실전 체크리스트입니다."
    tags = @("경제", "월세", "협상")
    section = "경제"
    keywords = "경제,월세인상,주거비,협상,체크리스트"
    image = "strategy-plan.jpg"
    topic = "월세 인상 통보 대응"
  },
  [ordered]@{
    title = "가구 교체 vs 수리 판단 가이드 2026"
    slug = "economy-furniture-buy-now-or-wait-guide-2026.html"
    summary = "가구가 낡았을 때 교체와 수리 중 손해를 줄이기 위해, 사용기간·수리비·이사 계획을 함께 보는 판단 기준을 정리했습니다."
    tags = @("경제", "가구", "소비판단")
    section = "경제"
    keywords = "경제,가구교체,수리판단,생활비,소비의사결정"
    image = "strategy-plan.jpg"
    topic = "가구 교체 판단"
  }
)
